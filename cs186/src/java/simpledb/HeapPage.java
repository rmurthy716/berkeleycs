...
public class HeapPage implements Page {
    ...
    */
	...
	markSlotUsed(t.getRecordId().tupleno(), true);
	...
	if (getNumEmptySlots() == 0
	    || !td.equals(t.getTupleDesc())) {
	    throw new DbException("Page is full or tuple is incompatible");
	}
	...
	return new Iterator<Tuple>() {
		...
		while (cur < getNumTuples()) {
		    if (isSlotUsed(cur)) return true;
		    cur++;
		}
		return false;
            }
